...
namespace MapDownloader
{
    public partial class MainForm : Form
    {
        ...
        private void InitMap()
        {
            ...
            BaiduMapProvider.Instance.Copyright = string.Empty;
        ...
        private void 以此为终点ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (routeStartPoint != PointLatLng.Empty)
            {
                ...
                MapRoute route = GetRoute(routeStartPoint, routeEndPoint, currentCenterCityName);
        ...
        public GMapRoute GetRoute(PointLatLng start, PointLatLng end, string cityName)
        {
            ...
            string KEY = "26144cb5dbe74ea6c1410777feb646de";
