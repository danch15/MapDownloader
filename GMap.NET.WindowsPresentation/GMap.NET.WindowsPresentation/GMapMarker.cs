...
namespace GMap.NET.WindowsPresentation
{
    ...
    public class GMapMarker : INotifyPropertyChanged
    {
        ...
        static readonly PropertyChangedEventArgs ViewModel_PropertyChangedEventArgs = new PropertyChangedEventArgs("ViewModel");
        /// <summary>
        /// custom object
        /// </summary>
        public object ViewModel
        {
            ...
            {
                viewModel = value;
                OnPropertyChanged(ViewModel_PropertyChangedEventArgs);
            }
        }
